!function(r, t) {
    ...
    function c(t, e, a, n, o, i, u) {
        ...
        var f = Math.floor(a / 2) + 1, c = new Array(a).fill(0).map(function(r, n) {
            return t * function(r, t) {
                return Math.log2(16 * r / t);
            }(e * n / a, u);
        });
        c[0] = c[1] - 1.5 * t;
        var l, s, m, p = c.slice(1).map(function(r, t) {
            return Math.max(r - c[t]);
        }, 1).concat([
            1
        ]), h = Math.round(t / 2), g = new Array(t).fill(0).map(function(r, e) {
    ...
    function s(r) {
        var t = r.ampSpectrum, e = r.barkScale, a = r.numberOfBarkBands, n = void 0 === a ? 24 : a;
        if ("object" != typeof t || "object" != typeof e) throw new TypeError;
        var o = n, i = new Float32Array(o), u = 0, f = t, c = new Int32Array(o + 1);
        c[0] = 0;
    ...
    function p(r) {
        var t = r.ampSpectrum, e = r.melFilterBank, a = r.bufferSize;
        if ("object" != typeof t) throw new TypeError("Valid ampSpectrum is required to generate melBands");
        if ("object" != typeof e) throw new TypeError("Valid melFilterBank is required to generate melBands");
        for(var n = m({
            ampSpectrum: t
    ...
    var y = Object.freeze({
        ...
        spectralSlope: function(r) {
            var t = r.ampSpectrum, e = r.sampleRate, a = r.bufferSize;
            if ("object" != typeof t) throw new TypeError;
        ...
        spectralRolloff: function(r) {
            var t = r.ampSpectrum, e = r.sampleRate;
            if ("object" != typeof t) throw new TypeError;
        ...
        powerSpectrum: m,
        mfcc: function(r) {
            var t = r.ampSpectrum, e = r.melFilterBank, a = r.numberOfMFCCCoefficients, n = r.bufferSize, o = Math.min(40, Math.max(1, a || 13));
        ...
        chroma: function(r) {
            var t = r.ampSpectrum, e = r.chromaFilterBank;
        ...
        spectralFlux: function(r) {
            var t = r.signal, e = r.previousSignal, a = r.bufferSize;
            if ("object" != typeof t || "object" != typeof e) throw new TypeError;
    ...
    var _ = {}, b = {}, M = {
        ...
        var e = t.real.length, a = Math.log2(e);
        ...
        for(var f = 1; f <= a; f++)for(var c = Math.pow(2, f), l = 0; l < c / 2; l++)for(var s = M.euler(l, c), m = 0; m < e / c; m++){
            var p = c * m + l, h = c * m + l + c / 2, g = {
                real: t.real[p],
                imag: t.imag[p]
            }, w = {
                real: t.real[h],
                imag: t.imag[h]
            }, v = M.multiply(s, w), d = M.subtract(g, v);
...
//# sourceMappingURL=index.9fa43c2d.js.map
